local fileName = debug.getinfo(1,'S').source:match("^.+/(.+)$"):gsub('.lua', '')
local skinData = {
	-- names
	skinName = fileName,
	ytdName = fileName,
	...
	-- icon locations
	lightsLoc = {0.015,0.15,0.018,0.02},
	blinkerLoc = {0.04,0.15,0.022,0.03},
	fuelLoc = {-0.005,0.15,0.012,0.025},
	oilLoc = {0.100,0.15,0.020,0.025},
	engineLoc = {0.130,0.15,0.020,0.025},

	-- gauge locations
	--[[UNUSED]]SpeedoBGLoc = {0.0625, 0.019, 0.238,0.238},
	--[[UNUSED]]SpeedoNeedleLoc = {0.0,5,0.076,0.15},

	TachoBGloc = {0.110,0.02,0.18,0.3},
	TachoNeedleLoc = {0.110,0.020, 0.09, 0.16},
	RevLight = {0.0645, 0.0935, 0.18 / 2,0.3 / 2},

	TurboBGLoc = {0.053, -0.150, 0.18 / 2.6, 0.3 / 2.6},
	TurboGaugeLoc = {0.053, -0.150, 0.09 / 2, 0.16 / 2},

	--[[UNUSED]]FuelBGLoc = {0.110, 0.093,0.050, 0.040},
	--[[UNUSED]]FuelGaugeLoc = {0.060,0.000,0.030,0.080},
	enableDigits = true,
	enableGear = true,

	-- you can also add your own values and use them in the code below, the sky is the limit!
	GearLoc = {0.13,-0.17, 0.1, 0.16}, -- gear location
