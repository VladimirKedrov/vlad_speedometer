local skinData = {
	...
	-- gauge locations
	SpeedoBGLoc = {0.11, 0.012, 0.16,0.275},
	SpeedoNeedleLoc = {0.0,5.0,0.07,0.07},

	TachoBGloc = {0.110,-0.015,0.159,0.222},
	TachoNeedleLoc = {0.110,0.010,0.115,0.185},
	...
	GearLoc = {0.157,0.133,0.014,0.021}, -- gear location
	Speed1Loc = {0.065,0.1205,0.017,0.028}, -- 3rd digit
	Speed2Loc = {0.083,0.1205,0.017,0.028}, -- 2nd digit
	Speed3Loc = {0.101,0.1205,0.017,0.028}, -- 1st digit
	UnitLoc = {0.126,0.127,0.030,0.019},
	TurboBGLoc = {0.053, -0.170, 0.075,0.110},
	TurboGaugeLoc = {0.0533, -0.170, 0.045,0.060},
